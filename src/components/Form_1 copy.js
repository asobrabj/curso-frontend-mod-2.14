      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='container_result'>
            ...
            <ul>
                ...
                <li key={index}>
                    <p className='lista_p'>Nome: {item.nome}</p>
                    <p className='lista_p'>Endereço: {item.endereco}</p>
                    <p className='lista_p'>Celular: {item.celular}</p>
                    <p className='lista_p'>Idade: {item.idade} anos</p>
                    <p className='lista_p'>Aceita Termos: {item.aceitaTermos ? 'Sim' : 'Não'}</p>
                </li>
                ))}
            </ul>
            )}
